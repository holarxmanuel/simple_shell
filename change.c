#include "shell.h"
/**
 * _updatepwd - chae the OLDPWD env variable
 * @buf: pointer to old p
 * @myenv: copy of environtal variable
 * Return: the string ins PWD env variable
 */
...
/**
 * _updateoldpwd - change OLDPWD env variable
 * @buf: pointo old pwd
 * @myenv: copf environmental variable
 * Return: theside PWD env variable
 */
